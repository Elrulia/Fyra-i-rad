    ...
    WHEN("Test that four pieces stacked in column wins the game") {
      WHEN("The game starts.") {
        THEN(
            ...
            v.print()) {
          REQUIRE(game.getCurrentStatus() == GameStatus(GameStatus::READY));
        }
        ...
        WHEN(
          ...
          THEN(
              ...
              "and the board should look like:\n" +
              v.print()) {
            REQUIRE(game.getCurrentStatus() == GameStatus(GameStatus::IN_GAME));
          }
            ...
            WHEN(
              ...
              WHEN("Yellow plays on the 1st column") {
                ...
                THEN(
                    ...
                    v.print()) {
                  REQUIRE(game.getCurrentStatus() ==
                          GameStatus(GameStatus::YELLOW_WON));
                }
              }
            }
          }
      ...
      WHEN(
        ...
        WHEN("Red plays on the 2nd column") {
          ...
          THEN(
              ...
              v.print()) {
            REQUIRE(game.getCurrentStatus() ==
                    GameStatus(GameStatus::GameStatus::RED_WON));
            REQUIRE(status == true);
          }
          WHEN("Yellow plays on the 3rd column") {
            bool status = game.yellowPlays(3);
